package com.github.myname.mymod.entity;
...
public final class ModEntities {
    ...
    //public static final Supplier<EntityType<ExampleEntity>> EXAMPLE_ENTITY = register("example", ExampleEntity::new, MobCategory.CREATURE, 0.6f, 1.8f);
